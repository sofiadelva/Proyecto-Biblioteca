...
<style>
    /* ESTILO DE BADGES PARA ESTADO FIJO (DISPONIBLE) */
            ...
            <div class="card-body py-3">
                ...
                <form class="d-flex align-items-center" method="get" action="<?= base_url('inventario'); ?>">
                    ...
                    <select name="cantidad_disponible" class="form-select w-auto me-2">
                        ...
                        <option value="0" <?= (isset($cantidadDisponible) && $cantidadDisponible == '0') ? 'selected' : '' ?>>0 disponibles</option>
                        <option value="1" <?= (isset($cantidadDisponible) && $cantidadDisponible == '1') ? 'selected' : '' ?>>1 o más</option>
                    </select>
...
<table class="table clean-table my-3">
    ...
    <?php if (!empty($libros)): ?>
        <?php foreach($libros as $libro): ?>
            <tr>
                ...
                <td>
                    <span class="badge badge-estado-disponible">
                        <?= esc($libro['estado']) ?>
                    </span>
                </td>
    ...
    <?php else: ?>
        <tr>
            <td colspan="7" class="text-center text-muted">No se encontraron libros disponibles que coincidan con los criterios.</td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
