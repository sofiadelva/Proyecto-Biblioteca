...
<head>
    ...
    <style>
    /* Estilo para la fuente 'beyond_the_mountains' - Mantenemos el estilo del Admin */
    @font-face {
    ...
    /* --- ESTILOS GENERALES Y LAYOUT (Panel completo de Bibliotecario) --- */
    body, html {
        height: 100%;
        margin: 0;
    ...
    /* --- WELCOME CARD (Original Admin: Cyan/Azul agua) --- */
    .welcome-card {
    ...
    /* --- HEADER LOGO (SCJ, Ocultando Everbook - Fiel al Admin) --- */
    .header-logo {
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    /* Imagen superpuesta (SCJ) */
    .header-image-overlay {
        max-height: 90%; 
        width: auto;
        filter: drop-shadow(0 2px 5px rgba(0, 0, 0, 0.4)); 
    }
    /* Ocultamos cualquier rastro de Everbook en esta sección */
    .header-logo .logo-img,
    .header-logo span,
    .header-logo-content img.logo-img,
    ...
    /* --- IMAGEN INFERIOR (Ardilla/Armadillo - Mayor tamaño) --- */
    .col-lg-7 {
        display: flex;
        flex-direction: column;
        flex-grow: 1;
    ...
    .image-card-section {
        ...
        flex-grow: 1; /* Crecimiento máximo */
        min-height: 250px; /* Altura mínima para asegurar visibilidad */
    }
    
    /* --- KPI CARDS (Rojo/Vino y Amarillo/Dorado - Mayor tamaño) --- */
    .dashboard-grid {
        display: grid;
    ...
    .kpi-card {
        ...
        border-radius: 12px;
        padding: 40px 25px; /* Aumentado padding para mayor tamaño */
        text-align: left;
    ...
    .kpi-card .kpi-title {
        font-size: 1.2rem; /* Texto del título ligeramente más grande */
        font-weight: 600; 
        line-height: 1.2;
        color: #ffffff !important; 
    }
        ...
        <nav class="col-md-2 d-none d-md-block sidebar py-4">
            <ul class="nav flex-column" id="sidebarMenu">
                ...
                <li class="nav-item mb-3">
                    <a class="nav-link active" href="<?= base_url('alumno/dashboard'); ?>">
                ...
                <li class="nav-item mb-3">
                    <a class="nav-link" href="<?= base_url('alumno/prestamos'); ?>">
